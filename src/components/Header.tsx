    ...
    <div className="bg-zinc-900 py-12">
      <div className="max-w-7xl m-auto px-3 flex justify-between items-center">
        <div className="w-1/2 sm:w-7/12 lg:w-1/2 flex justify-between items-center">
          ...
          <nav className="w-3/5 sm:w-8/12 lg:w-3/5 lg:max-w-[350px] hidden sm:flex">
            <ul className="w-full flex justify-between text-neutral-400 sm:text-sm md:text-base">
        ...
        <div className="w-1/6 xl:w-[14%]  hidden sm:flex justify-between">
          <div className=" aspect-square w-9 md:w-10 lg:w-12 bg-zinc-800 rounded flex justify-center items-center cursor-pointer">
            <Image
